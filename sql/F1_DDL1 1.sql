	...
	IF EXISTS (SELECT name FROM sys.databases WHERE name = 'F1ManagementDB')
	BEGIN
		ALTER DATABASE F1ManagementDB SET SINGLE_USER WITH ROLLBACK IMMEDIATE;
	...
	CREATE TABLE RECORDS (
		...
		Record_Type VARCHAR(50) NOT NULL CHECK (Record_Type IN ('Fastest_Lap_Time', 'Most_Overtakes', 'Most_Wins_Season', 'Most_Poles_Season', 'Championship_Record')),
		Fastest_Lap_Time DECIMAL(10,3) NULL,
